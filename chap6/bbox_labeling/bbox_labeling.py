# sample.labels 存放提前设置好的标注信息（类别，标注框的颜色）
# 标注之后会对每一个被标注过的图片产生相应的标注文件：“图片名+bbox”
    ...
    def start(self):
        ...
        while key != KEY_ESC:
            ...
            # 删除当前图片和对应标注信息
                ...
                if messagebox.askokcancel('Delete Sample', 'Are you sure?'):
...
if __name__ == '__main__':
    dir_with_images = filedialog.askdirectory(title='Where are the images?')
